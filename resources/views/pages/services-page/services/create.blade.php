...
<div class="d-flex justify-content-between align-items-center">
    <div>
        ...
        <div class="page-subtitle">Add a new service to your offerings</div>
    </div>
    <div class="btn-list">
...
<form action="{{ route('services.services.store') }}" method="POST" enctype="multipart/form-data" id="service-form">
    @csrf
    <div class="row g-3">
        {{-- Main Content --}}
        <div class="col-lg-8">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('short_description') is-invalid @enderror" 
                                          ...
                                          placeholder="Enter detailed description of the service...">{{ old('short_description') }}</textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control @error('icon') is-invalid @enderror" 
                                       name="icon" accept="image/*" required id="icon-input">
                                @error('icon')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-hint">
                                    <i class="ti ti-info-circle me-1"></i>
                                    Upload service icon. Max: 2MB (JPG, PNG, WebP, SVG)
                                </small>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('icon_alt_text') is-invalid @enderror" 
                                       name="icon_alt_text" value="{{ old('icon_alt_text') }}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <small class="form-hint">
                                    <i class="ti ti-info-circle me-1"></i>
                                    Upload service image. Recommended: 1200x800px, Max: 15MB
                                </small>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="text-secondary small">
                        <ul class="mb-0">
                            <li class="mb-2">Use high-quality images that represent your service well</li>
                            <li class="mb-2">Keep service names concise but descriptive</li>
                            <li class="mb-2">Write clear descriptions that highlight key benefits</li>
                            <li class="mb-0">Choose layout based on your content flow preference</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    function setupFormSubmission() {
        ...
        form.addEventListener('submit', function(e) {
            ...
            if (!imageInput.files.length) {
                e.preventDefault();
                if (!hasError) imageInput.focus();
                showAlert(imageInput, 'danger', 'Please select an image for the service.');
                hasError = true;
            }
            ...
            if (!hasError) {
                ...
                submitBtn.innerHTML = '<span class="spinner-border spinner-border-sm me-2"></span>Creating Service...';
