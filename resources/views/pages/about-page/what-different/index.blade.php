...
@section('title', 'What Different Management')
...
<div class="d-flex justify-content-between align-items-center">
    <div>
        <h2 class="page-title">What Different Management</h2>
        <div class="page-subtitle">Manage what makes us different items for About page</div>
    </div>
    <div class="btn-list">
...
<div class="col-12">
    <form method="GET" action="{{ route('about-page.what-different.index') }}" id="filter-form">
        <div class="d-flex justify-content-start align-items-center gap-2">
            ...
            <div class="d-flex gap-2 align-items-center">
                ...
                <a href="{{ route('about-page.what-different.index') }}" class="btn btn-outline-secondary" title="Clear all filters">
                    <i class="ti ti-x"></i>
                </a>
                @endif
            </div>
                            ...
                            <td class="text-center">
                                <div class="btn-list">
                                    ...
                                    <button type="button" 
                                            ...
                                            data-url="{{ route('about-page.what-different.destroy', $item) }}"
                                            title="Delete Item">
                            ...
                            <td colspan="5" class="text-center py-5">
                                <div class="empty">
                                    <div class="empty-icon">
                                        ...
                                        @else
                                        <i class="ti ti-star icon icon-lg"></i>
                                        @endif
                                    </div>
                                    ...
                                    <p class="empty-subtitle text-secondary">
                                        ...
                                        @else
                                        Get started by creating your first what different item.<br>
                                        Highlight what makes your company unique and different from competitors.
                                        @endif
                                    </p>
                                    <div class="empty-action">
                                        @if(request('search') || request('status') || request('page'))
                                        <a href="{{ route('about-page.what-different.index') }}" class="btn btn-outline-secondary">
...
<div class="modal modal-blur fade" id="create-item-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <form class="modal-content" method="POST" action="{{ route('about-page.what-different.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="ti ti-star me-2"></i>
                    Create What Different Item
                </h5>
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="title" required
                           placeholder="e.g., Innovation Excellence" id="create-title-input">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="description" rows="4" required
                              placeholder="Describe what makes this aspect different and unique..." id="create-description-input"></textarea>
                    <small class="form-hint">
                        Explain what makes this particular aspect unique to your company.
                    </small>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <small class="form-hint d-block">
                        ...
                        Only active items will be displayed on the About page.
                    </small>
                </div>
            </div>
...
<script>
    ...
    function updateOrder(orders) {
        fetch('{{ route('about-page.what-different.update-order') }}', {
            method: 'POST',
            headers: {
    ...
    function setupModals() {
        ...
        document.addEventListener('click', function(e) {
            if (e.target.classList.contains('edit-btn') || e.target.closest('.edit-btn')) {
                ...
                document.getElementById('edit-form').action = `{{ url('about-page/what-different') }}/${itemId}`;
